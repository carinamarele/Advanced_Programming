...
public interface GameModelView
{
     ...
     */
    boolean isFinalePileStackEmpty(FinaleStackOrder pIndex);
     ...
     */
    CardStack getIndexCardsPile(IndexCardsPile pIndex);
     ...
     *     the tableau;
     */
    boolean isVisibleInStackDownGame(Card pCard);
     ...
     */
    boolean isLowestVisibleInStackDownGame(Card pCard);
