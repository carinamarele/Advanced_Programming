...
//settere si gettere pentru preluarea si fixarea costului,numelui bisericii
    ...
    public String toString() {
        return "Biserica se deschide la ora " + openingTime +
                ", se inchide la ora" + closingTime +
                ", se afla pe Strada " + adresa + '\'' +
                ", este de tip " + religie + '\'' +
                ", capacitatea maxima a bisericii este de " + capacitate +
                " persoane si se numeste "+COLOR_BLUE+name+RESET+".\n";
    }
